...
- The workflow framework will automatically:
  ...
  - Load workflow variables from `{projectRoot}/.agents/skills/bmad-create-story/workflow.md`
...
1. **Load the workflow configuration**: `{projectRoot}/.agents/skills/bmad-create-story/workflow.md` for variable inclusion
