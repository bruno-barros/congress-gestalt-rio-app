...
export default class Abstract {
  ...
  statusPassed(desiredStatus: StatusType) {
    const desiredPosition: number =
      STATUSES_SINOPSIS_ABSTRACT_MODEL.indexOf(desiredStatus);
    const currentPosition: number = STATUSES_SINOPSIS_ABSTRACT_MODEL.indexOf(
      this.status
    );
  ...
  /**
   * Dependendo do contexto o usuário não pode editar o trabalho
   * @returns
   */
  isAbleToEdit() {
