...
interface MainLayoutProps {
  ...
  pageHeader?: { title: string } | Element | ReactNode;
  fullWidth?: boolean;
}
...
function MainLayout({
  ...
  return (
    <div className={`layout-main`}>
      ...
      {!user.hasMinimumRegisteredFields() && (
        <CurtainDelayed>
          <div className="alert alert-warning text-center mb-0">
            <Trans as="p" i18nKey="cadastro.esta-incompleto">
              Seu cadastro está incompleto. Por favor,{" "}
              <a
                href=""
                onClick={(e) => {
                  e.preventDefault();
      ...
      {pageHeader &&
        (typeof pageHeader === "object" && "title" in pageHeader ? (
      ...
      <main
        className={`main ${fullWidth && "full-width"} ${
